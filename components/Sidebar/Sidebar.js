          ...
          >
            ...
            <div className="md:min-w-full md:hidden block pb-4 mb-4 border-b border-solid border-blueGray-200">
              <div className="flex flex-wrap">
                <div className="w-6/12">
                  <Link href="/" id="#pablo"  className="md:block text-left md:pb-2 text-blueGray-600 mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0"
                  >
                    Notus NextJS
                  </Link>
                </div>
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                <Link href="/admin/dashboard" id="#pablo"
                  className={
              ...
              <li className="items-center">
                <Link href="/admin/settings" id="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
              ...
              <li className="items-center">
                <Link href="/admin/tables" id="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              ...
              <li className="items-center">
                <Link href="/auth/register" id="#pablo"
                    className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                  >
